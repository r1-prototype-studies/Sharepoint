...
import styles from "./ExternalLibraryWebPart.module.scss";
...
export default class ExternalLibraryWebPart extends BaseClientSideWebPart<IExternalLibraryWebPartProps> {
  ...
  public constructor() {
    ...
    SPComponentLoader.loadCss(
      "https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/themes/redmond/jquery-ui.min.css"
    );
  }
  ...
  public render(): void {
    this.domElement.innerHTML = AccordianTemplate.templateHtml;
