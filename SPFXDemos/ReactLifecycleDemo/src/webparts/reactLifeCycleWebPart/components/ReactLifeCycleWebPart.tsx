...
export default class ReactLifeCycleWebPart extends React.Component<IReactLifeCycleWebPartProps, {}> {
  public render(): React.ReactElement<IReactLifeCycleWebPartProps> {
    ...
    return (
      <section className={`${styles.reactLifeCycleWebPart} ${hasTeamsContext ? styles.teams : ''}`}>
